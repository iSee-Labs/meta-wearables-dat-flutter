...
import 'package:camera_access/src/devices_screen.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          _NavigationTile(
            icon: Icons.devices,
            title: 'Devices',
            subtitle: 'Paired devices and per-device compatibility.',
            enabled: true,
            onTap: () => Navigator.of(context).push<void>(
          ...
          _NavigationTile(
            ...
            subtitle: 'Develop without hardware: pair, power, don, set feeds.',
            enabled: true,
            onTap: () => Navigator.of(context).push<void>(
